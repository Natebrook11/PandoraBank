function chatBot() {
    return {
        ...
        replies: [
            ...
            ["Haha!", "Good one!"],
            ["Heads", "Tails"],
            ["You can buy me a beer at: <a href=\"https://beer.com\" target=\"_blank\" style=\"text-decoration:underline;\">https://beer.com</a>"]
        ],
        alternative: ["I don't know the answer for that",  "Try again",  "I don't understand :/"],
        coronavirus: ["Please stay home", "Wear a mask", "Fortunately, I don't have COVID", "These are uncertain times"],
        botTyping: false,
        messages: [{
            from: 'bot',
            text: 'Hey Welcome to Pandora. AI chatbot ask me something!'
        }],
